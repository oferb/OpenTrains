...
# TODO: move to ShapeList
def get_shape_probabilities(shape_int_ids, query_coords, query_accuracies_in_coords):

    all_shapes = ShapeList.all_shapes
